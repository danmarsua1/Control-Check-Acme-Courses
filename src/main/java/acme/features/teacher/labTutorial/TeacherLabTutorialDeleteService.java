/*
 * TeacherLabTutorialDeleteService.java
 *
...
@Service
public class TeacherLabTutorialDeleteService implements AbstractDeleteService<Teacher, LabTutorial>{
	...
	@Override
	public void delete(final Request<LabTutorial> request, final LabTutorial entity) {
		
		assert request != null;
		assert entity != null;
		
		Collection<Register> registers = this.registerRepository.findManyRegisterByLabTutorial(entity.getId());
