...
<acme:list>
	<acme:list-column code="learner.follow-up.list.label.sequenceNumber" path="sequenceNumber" width="30%"/>
	<acme:list-column code="learner.follow-up.list.label.message" path="message" width="70%"/>	
</acme:list>
